...
namespace CosmosSharp.Types
{
    ...
    public class MultipleMsgSend : IMsg
    {
    ...
    public class PubKey
    {
        ...
        public string PubKeySecp256k1Value
        {
            get
            {
                if (this.Type != PubKeySecp256k1) return null;
                return (string)Value;
            }
        }
        ...
        public PubKeyMultisigThreshold PubKeyMultisigThresholdValue
        {
            get
            {
                if (this.Type != PubKeyMultisigThreshold) return null;
    ...
    public class StdSignMsg : StdSignMsgBase
    {
        ...
        [JsonProperty("msgs", Order = 5)] public List<Msg> Msg { get; set; }
    }
